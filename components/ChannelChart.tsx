...
import type { Ticket, ChannelStats, MetricType } from "@/lib/types";
...
export default function ChannelChart({
  ...
  const data: ChannelStats[] = useMemo(() => {
    ...
    return Object.values(map)
      .map((d) => ({
        ...d,
        avgResMin: median(mins[d.channel] ?? []),
      }))
